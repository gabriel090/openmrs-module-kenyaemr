<%
	ui.decorateWith("kenyaui", "panel", [ heading: "Visit Information", frameOnly: true ])
%>
...
<div class="ke-panel-footer">
	...
	<button type="button" onclick="ui.navigate('${ ui.pageLink("kenyaemr", "nutrition/editNutrition", [ patientId: patient.id, returnUrl: ui.thisUrl() ]) }')">
		<img src="${ ui.resourceLink("kenyaui", "images/glyphs/add.png") }" /> Add Instruction
	</button>
</div>