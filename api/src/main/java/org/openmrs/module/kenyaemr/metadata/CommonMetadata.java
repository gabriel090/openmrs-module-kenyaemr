...
public class CommonMetadata extends AbstractMetadataBundle {
	...
	public static final class _EncounterType {
		...
		public static final String NUTRITION = "1a64b6d8-d712-48d8-8e2e-a71bdfcf67a4";
	...
	public static final class _Form {
		...
		public static final String NUTRITION_ENCOUNTER = "40218fa2-7632-438f-b5d9-c062e938e00e";
	}
	...
	public void install() {
		...
		install(encounterType("Nutrition services", "Nutrition services", _EncounterType.NUTRITION));
		...
		install(form("Nutrition Form", "Form for Nutrition services ", _EncounterType.NUTRITION, "1", _Form.NUTRITION_ENCOUNTER));
